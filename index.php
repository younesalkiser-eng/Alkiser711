...
$chall = "you_k711";
$useradmin = "y_k711";
$sim =-1004295828574; #القناة الرسمية
$PAY =-1004493721693; #الارقام المكتملة
$ess =-1004397851569; #عمليات شراء الارقام
$eer =-1004497724053; #اشعارات الايميلات وتحويل الروبل
if($chat_id==5318946064){
$sudo=$chat_id;
}elseif($chat_id==5318946064){
$sudo=$chat_id;
}else{
$sudo==5318946064;
}
